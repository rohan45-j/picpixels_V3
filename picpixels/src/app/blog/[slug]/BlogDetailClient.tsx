...
export default function BlogDetailClient({ post, allPosts }: { post: BlogPost; allPosts: BlogPost[] }) {
            ...
            <Reveal variant="fadeUp" delay={50}>
              <div className={styles.docSection}>
                ...
                <div className={styles.docList}>
                  {post.document_blocks.filter((d: any) => d.is_active).sort((a: any, b: any) => (a.sort_order ?? 0) - (b.sort_order ?? 0)).map((doc: any) => (
